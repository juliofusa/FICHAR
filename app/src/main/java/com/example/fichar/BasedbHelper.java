...
public class BasedbHelper extends SQLiteOpenHelper {
    ...
    String sqlCreateSOLICITUD = "CREATE TABLE FICHAJE (_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, FECHA TEXT, CLIENTE TEXT, HORA_ENTRADA TEXT, HORA_SALIDA TEXT,GPS_ENTRADA TEXT,GPS_SALIDA TEXT, COMODIN TEXT, DIRECCION_ENTRADA TEXT, DIRECCION_SALIDA TEXT)";
